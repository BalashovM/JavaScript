...
//Имена тайлов
const TILE_PATH = "img/";//местонахождение тайлов
const TILE_EXT = ".png";
...
const score = {
    ...
    */
    resetScore() {
        ...
        this.isHightScore = false;
    },

    /*Свойство максимального очков - меняется картинка на змейку в очках*/
    isHightScore : false,
...
preloadImages([
    ...
    "head_d_hscore", "head_u_hscore", "head_l_hscore", "head_r_hscore",
